...
public class VarthaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ItemOffsetDecoration itemDecoration = new ItemOffsetDecoration(VarthaActivity.this, R.dimen.item_offset);
    ...
    private List<Data> getData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://nammalerattupettakkar.000webhostapp.com/news.php",
        ...
        Volley.newRequestQueue(VarthaActivity.this).add(stringRequest);
        return list;
    }
    class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder>{
        ...
        public void onBindViewHolder(@NonNull Adapter.MyViewHolder myViewHolder, int i) {
            ...
            myViewHolder.title.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(VarthaActivity.this,VarthaDetailActivity.class);
            ...
            Glide.with(getApplicationContext()).load(data.getImage()).into(myViewHolder.img_thumb);
            ...
            myViewHolder.img_thumb.setOnClickListener(view -> {
        ...
        public class MyViewHolder extends RecyclerView.ViewHolder {
            ...
            private TextView title,txt_description;
            CardView card;
