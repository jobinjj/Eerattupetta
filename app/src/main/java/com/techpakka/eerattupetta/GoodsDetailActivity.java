...
import com.techpakka.eerattupetta.Vahanangal.VahanangalTaxiDetail;
...
public class GoodsDetailActivity extends AppCompatActivity {
    ...
    RecyclerView maximo_recycler,pickup_recycler,tipper_recycler,lorry_recycler,jcb_recycler;
    Adapter maximoAdapter,pickupAdapter,tipperAdapter,lorryAdapter,jcb_adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maximoAdapter = new Adapter(getMaximoData());
        pickupAdapter = new Adapter(getPickUpData());
        tipperAdapter = new Adapter(getTipperData());
        lorryAdapter = new Adapter(getLorryData());
        jcb_adapter = new Adapter(getJCBData());
        maximo_recycler = findViewById(R.id.maximo_recycler);
        pickup_recycler = findViewById(R.id.pickup_recycler);
        tipper_recycler = findViewById(R.id.tipper_recycler);
        lorry_recycler = findViewById(R.id.lorry_recycler);
        jcb_recycler = findViewById(R.id.jcb_recycler);

        jcb_recycler.setNestedScrollingEnabled(false);
        jcb_recycler.setHasFixedSize(false);
        jcb_recycler.setLayoutManager(new LinearLayoutManager(this));
        ItemOffsetDecoration itemDecoration2 = new ItemOffsetDecoration(GoodsDetailActivity.this, R.dimen.item_offset);
        jcb_recycler.addItemDecoration(itemDecoration2);
        jcb_recycler.setItemAnimator(new DefaultItemAnimator());
        jcb_recycler.setAdapter(jcb_adapter);

        maximo_recycler.setNestedScrollingEnabled(false);
        maximo_recycler.setHasFixedSize(false);
        maximo_recycler.setLayoutManager(new LinearLayoutManager(this));
        ItemOffsetDecoration itemDecoration6 = new ItemOffsetDecoration(GoodsDetailActivity.this, R.dimen.item_offset);
        maximo_recycler.addItemDecoration(itemDecoration6);
        maximo_recycler.setItemAnimator(new DefaultItemAnimator());
        maximo_recycler.setAdapter(maximoAdapter);

        lorry_recycler.setNestedScrollingEnabled(false);
        lorry_recycler.setHasFixedSize(false);
        lorry_recycler.setLayoutManager(new LinearLayoutManager(this));
        ItemOffsetDecoration itemDecoration5 = new ItemOffsetDecoration(GoodsDetailActivity.this, R.dimen.item_offset);
        lorry_recycler.addItemDecoration(itemDecoration5);
        lorry_recycler.setItemAnimator(new DefaultItemAnimator());
        lorry_recycler.setAdapter(lorryAdapter);

        tipper_recycler.setNestedScrollingEnabled(false);
        tipper_recycler.setHasFixedSize(false);
        tipper_recycler.setLayoutManager(new LinearLayoutManager(this));
        ItemOffsetDecoration itemDecoration3 = new ItemOffsetDecoration(GoodsDetailActivity.this, R.dimen.item_offset);
        tipper_recycler.addItemDecoration(itemDecoration3);
        tipper_recycler.setItemAnimator(new DefaultItemAnimator());
        tipper_recycler.setAdapter(tipperAdapter);

        pickup_recycler.setNestedScrollingEnabled(false);
        pickup_recycler.setHasFixedSize(false);
        pickup_recycler.setLayoutManager(new LinearLayoutManager(this));
        ItemOffsetDecoration itemDecoration4 = new ItemOffsetDecoration(GoodsDetailActivity.this, R.dimen.item_offset);
        pickup_recycler.addItemDecoration(itemDecoration4);
        pickup_recycler.setItemAnimator(new DefaultItemAnimator());
        pickup_recycler.setAdapter(maximoAdapter);
    }

    private List<Data> getJCBData() {
        ...
        try {
            ...
            for (int i = 0; i < vehicles.length(); i++) {
                ...
                if (c.getString("type_id").equals("11")){
                    Data data1 = new Data();
    ...
    private List<Data> getLorryData() {
        ArrayList<Data> list = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < vehicles.length(); i++) {
                JSONObject c = vehicles.getJSONObject(i);
                if (c.getString("type_id").equals("10")){
                    Data data1 = new Data();
                    data1.setTaxi_name(c.getString("name_malayalam"));
                    data1.setTaxi_location(c.getString("place"));
                    data1.setTaxi_mobile(c.getString("phone"));
    ...
    private List<Data> getTipperData() {
        ArrayList<Data> list = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < vehicles.length(); i++) {
                JSONObject c = vehicles.getJSONObject(i);
                if (c.getString("type_id").equals("9")){
                    Data data1 = new Data();
                    data1.setTaxi_name(c.getString("name_malayalam"));
                    data1.setTaxi_location(c.getString("place"));
                    data1.setTaxi_mobile(c.getString("phone"));
    ...
    private List<Data> getPickUpData() {
        ArrayList<Data> list = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < vehicles.length(); i++) {
                JSONObject c = vehicles.getJSONObject(i);
                if (c.getString("type_id").equals("8")){
                    Data data1 = new Data();
                    data1.setTaxi_name(c.getString("name_malayalam"));
                    data1.setTaxi_location(c.getString("place"));
                    data1.setTaxi_mobile(c.getString("phone"));
    ...
    private List<Data> getMaximoData() {
        ArrayList<Data> list = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < vehicles.length(); i++) {
                JSONObject c = vehicles.getJSONObject(i);
                if (c.getString("type_id").equals("7")){
                    Data data1 = new Data();
                    data1.setTaxi_name(c.getString("name_malayalam"));
                    data1.setTaxi_location(c.getString("place"));
                    data1.setTaxi_mobile(c.getString("phone"));
